...
export default function Music() {
  ...
  return (
    <div className='fixed w-fit h-fit  bottom-[70px] left-[70px] z-0'>
      <div className='sticky  w-fit h-[75px] z-50 flex justify-center items-center  bg-white bg-opacity-20 backdrop-blur-3xl text-white/70 rounded-xl'>
        <Image
